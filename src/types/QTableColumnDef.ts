export default interface QTableColumnDef {
   /**
    ...
    * @returns Comparison result of term 'a' with term 'b'.
    * Less than 0 when 'a' should come first; greater than 0 if 'b' should come first;
    * equal to 0 if their position must not be changed with respect to each other
    */
